...
import com.udacity.project4.authentication.FakeAuthenticationController
...
class RemindersActivityTest :
    ...
    private val fakePoi = PointOfInterest(LatLng(11.00, 11.00), "Fake_POI_ID", "Fake POI Title")
    ...
    fun init() {
        ...
        val myModule = module {
            ...
            single { FakeAuthenticationController(true) as Authenticator }
            single { listOf(fakePoi) }
        }
    ...
    @Test
    fun tryToCreateReminder() {
        // Reminder to be saved
        val reminder = ReminderDataItem(
            "Test Title 1", "Test Description 1",
            fakePoi.name, fakePoi.latLng.latitude, fakePoi.latLng.longitude
        )
        ...
        // Check if Save Reminder is loaded, clean and with hints
        ...
        onView(withId(R.id.selectedLocation)).check(matches(withText(fakePoi.name)))
